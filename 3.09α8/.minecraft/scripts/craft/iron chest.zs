...
recipes.addShaped(<ironchest:vanilla_copper_shulker_upgrade>, [[<abyssalcraft:copperingot>, <abyssalcraft:copperingot>, <abyssalcraft:copperingot>],[<abyssalcraft:copperingot>, <ore:plankWood>, <abyssalcraft:copperingot>],[<abyssalcraft:copperingot>, <abyssalcraft:copperingot>, <abyssalcraft:copperingot>]]);

//原版升级铁
recipes.remove(<ironchest:vanilla_iron_shulker_upgrade>);
recipes.addShaped(<ironchest:vanilla_iron_shulker_upgrade>, [[<minecraft:iron_ingot>, <minecraft:iron_ingot>, <minecraft:iron_ingot>], [<minecraft:iron_ingot>, <minecraft:iron_block>, <minecraft:iron_ingot>], [<minecraft:iron_ingot>, <minecraft:iron_ingot>, <minecraft:iron_ingot>]]);

//铜升级铁
recipes.remove(<ironchest:copper_iron_shulker_upgrade>);
recipes.addShaped(<ironchest:copper_iron_shulker_upgrade>, [[<minecraft:iron_ingot>,<minecraft:iron_ingot>, <minecraft:iron_ingot>], [<minecraft:iron_ingot>, <abyssalcraft:copperingot>, <minecraft:iron_ingot>],[<minecraft:iron_ingot>,<minecraft:iron_ingot>,<minecraft:iron_ingot>]]);

//铁升级金
recipes.remove(<ironchest:iron_gold_shulker_upgrade>);
recipes.addShaped(<ironchest:iron_gold_shulker_upgrade>, [[<minecraft:gold_ingot>, <minecraft:gold_ingot>, <minecraft:gold_ingot>], [<minecraft:gold_ingot>, <minecraft:iron_block>, <minecraft:gold_ingot>], [<minecraft:gold_ingot>, <minecraft:gold_ingot>, <minecraft:gold_ingot>]]);

//金升级钻石
recipes.remove(<ironchest:gold_diamond_shulker_upgrade>);
recipes.addShaped(<ironchest:gold_diamond_shulker_upgrade>, [[<minecraft:diamond>, <minecraft:diamond>, <minecraft:diamond>], [<minecraft:diamond>, <minecraft:gold_block>, <minecraft:diamond>], [<minecraft:diamond>, <minecraft:diamond>, <minecraft:diamond>]]);

//钻石升级透明
recipes.remove(<ironchest:diamond_crystal_shulker_upgrade>);
recipes.addShaped(<ironchest:diamond_crystal_shulker_upgrade>, [[<betternether:quartz_glass>, <betternether:quartz_glass>, <betternether:quartz_glass>], [<betternether:quartz_glass>, <minecraft:diamond>, <betternether:quartz_glass>], [<betternether:quartz_glass>, <betternether:quartz_glass>, <betternether:quartz_glass>]]);

//钻石升级黑曜石
recipes.remove(<ironchest:diamond_obsidian_shulker_upgrade>);
recipes.addShaped(<ironchest:diamond_obsidian_shulker_upgrade>, [[<minecraft:obsidian>, <minecraft:obsidian>, <minecraft:obsidian>], [<minecraft:obsidian>, <minecraft:diamond>, <minecraft:obsidian>], [<minecraft:obsidian>, <minecraft:obsidian>, <minecraft:obsidian>]]);
